...
<form method="POST" action="/EasyStub/abc">
   <table class="userHomeTable">
        <tr><td colspan="3" align="left"><h1>&nbsp;&nbsp;Select your task .....</h1></td></tr>
        <tr>
                <td class="userHomeCells"><a href="/EasyStub/newStub"><img  src="images/Certificate_Upload.jpg" height="150px" width="150px" border="0"/><br/>Create New Stub</a></td>
                <td class="userHomeCells"><a href="/EasyStub/viewStubs"><img  src="images/File_Upload.jpg" height="150px" width="150px" border="0"/> <br/>View Stubs</a></td>               
