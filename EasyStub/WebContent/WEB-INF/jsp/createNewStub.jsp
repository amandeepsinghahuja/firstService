...
<body   background="images/login_bg.jpg" > 
                <form action="/EasyDP/userHome" method="post">
                        <table class="commonTable">      
                                <tr><td colspan="2"><h1>&nbsp;&nbsp;&nbsp;Create New Stub.....</h1></td></tr>
                                <tr>
                                        <td><label for="Domain"><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stub Type:</h3></label></td>
                                        <td>
                                ...
                                <tr>                                
                                <tr>
                                        <td><label for="File"><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Upload Respose File:</h3></label></td>
                                        <td>
                                                <input type="file" id="filePath" name="upload" onchange='readmultifiles(files)' >
                                                <script>
                                                /* multiple="multiple"
