        ...
        <head>
                ...
                function showHide() { 
                     if (document.getElementById('hostCheck').checked) { 
                         document.getElementById('textHost').style.visibility = 'visible'; 
                         document.getElementById('buttonHost').style.visibility = 'visible';
                     } 
                     else { 
                         document.getElementById('textHost').style.visibility = 'hidden';
                         document.getElementById('buttonHost').style.visibility = 'hidden';
                     } 
                 };
                 </script>
                 -->
                <title>Easy DP Login Page</title>
        </head>
        <body background="images/login_bg.jpg">
               
                        <form action="/EasyDP/userHome" method="post" name="loginForm" id="loginForm" autocomplete="off" role="form">
                                 <table class="commonTable">                                        
                                        <tr><td colspan="2" ><h1>&nbsp;&nbsp;&nbsp;Easy DP Login .....</h1></td></tr>
                                        <tr>
